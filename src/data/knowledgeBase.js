...
export const people = [
  ...
  { name: 'Behar Simnica', role: 'Senior Developer', team: 'Development', office: 'Prishtina', languages: ['Albanian', 'English', 'German'], email: 'bs@comparit.de' },
  { name: 'Çlirim Murati', role: 'Senior Software Developer', team: 'Development', office: 'Prishtina', languages: ['Albanian', 'English', 'German'], email: 'cm@comparit.de' },
