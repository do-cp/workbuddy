...
export const categories = [
  ...
  },
  {
    ...
    sublabel: 'Who to ask for what',
    suggestions: [
      'Who do I talk to about IT problems?',
      'Who handles HR questions?',
      'Who manages office logistics?',
      "Who's the PM for UserCenter?",
    ],
  },
  {
    id: 'rules',
    ...
    sublabel: 'Home office, expenses, glossary',
    suggestions: [
