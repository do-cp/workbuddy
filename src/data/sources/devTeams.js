...
export const devTeamsData = {
  ...
  teams: [
    {
      id: "SACH",
      description:
        "Developers coding Sachversicherung products (WG, HR, PHV, THV, RS)",
    ...
    },
    {
      ...
      members: [
        ...
        },
        {
          ...
          note: "50% leadership/management KO",
        },
        {
          ...
          note: "Team Lead BE/UI",
        },
      ],
      projects: [
        "OVB Anbindung",
        "Telis Anbindung",
        "Userverwaltung Teil 1+2",
        "MLP KFZ Anbindung",
        "Asynchrone Beratung",
        "cpit.PILOT",
        "Digitale Signatur (cpit.SIGN)",
        "Umsatzsteuer Umsetzung",
      ],
    },
    {
      id: "IC Webservices",
    ...
    },
    {
      id: "KFZ",
      description:
        "Developers coding motor vehicle insurance (NOT Fachbereich KFZ contact)",
      ...
      projects: [
        "KFZ Refactoring",
        "WKZ Kraftrad/Nutzfahrzeug/Anhänger/Camping",
        "TAA-API Ausbau",
      ],
    },
    {
      id: "Kranken",
      description:
        "Developers coding health insurance (NOT Fachbereich KV contact)",
  ...
  noHamburgTechLead:
    "No named Hamburg Tech Team Lead exists in the source documents. For Hamburg dev questions → Ylle Dragaj (CTO, yd@comparit.de)",
};
